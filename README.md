...
You can also use an alternative emoji set based on the list at [unicodey](https://unicodey.com/emoji-data/table.htm). To enable this alternative set follow the instructions [here](./UNICODEY_TABLE.md).
